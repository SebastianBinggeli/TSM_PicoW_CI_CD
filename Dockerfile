...
RUN \
    mkdir -p /project \
    && cd /project \
    && curl -d "accept_license_agreement=accepted&submit=Download+software" -X POST -O "https://www.segger.com/downloads/jlink/JLink_Linux_V810j_x86_64.deb" 
...
RUN \
    cd /project \
    && dpkg --unpack JLink_Linux_V810j_x86_64.deb \
